...
describe('ConfigService', () => {
  ...
  describe('validateConfig', () => {
    ...
    it('should return false when Neo4j configuration is missing', () => {
      // Remove Neo4j password
      delete process.env.NEO4J_PASSWORD;
      
      // Create new config service with updated env
      const configServiceMissingNeo4j = new ConfigService();
    ...
    it('should return false when PostgreSQL configuration is missing', () => {
      ...
      // Create new config service with updated env
      const configServiceMissingPostgres = new ConfigService();
    ...
    it('should return false when Redis configuration is missing', () => {
      ...
      // Create new config service with updated env
      const configServiceMissingRedis = new ConfigService();
    ...
    it('should warn when using default JWT secret', () => {
      // Set JWT secret to default value
      ...
      // Create new config service with updated env
      const configServiceWithDefaultSecret = new ConfigService();
  ...
  describe('loadSecretFromFile', () => {
    ...
    // Note: Testing actual file reading would require creating temporary files
  ...
  describe('healthCheck', () => {
    ...
    it('should return false when configuration validation fails', () => {
      ...
      // Create new config service with updated env
      const configServiceInvalid = new ConfigService();
