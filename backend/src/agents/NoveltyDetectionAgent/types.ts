export interface NoveltyDetectionRequest {
  ...
  orgId: string
  userId: string
  context?: { projectId?: string; sourceId?: string; metadata?: Record<string, any> }
}
...
export interface NoveltyResult {
  ...
  detectedChanges: Array<{ property: string; oldValue?: any; newValue: any; changeType: 'added' | 'modified' | 'removed'; significance: number }>
  reasoning: string
