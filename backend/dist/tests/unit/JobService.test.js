...
describe('JobService', () => {
    ...
    beforeEach(() => {
        ...
        jobService = new JobService_1.JobService(mockQueueService);
    });
    ...
    describe('enqueueAgentJob', () => {
        it('should add a job to the queue', async () => {
            ...
            expect(mockQueue.add).toHaveBeenCalledWith('test-job', jobInput, { priority: 5 });
            expect(job).toEqual({
                id: mockJob.id,
                orgId: mockJob.data?.orgId,
                type: mockJob.name,
...
//# sourceMappingURL=JobService.test.js.map